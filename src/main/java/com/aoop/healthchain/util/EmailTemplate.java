...
public class EmailTemplate {
    ...
    public String getForgetPassTemplate()
    {
        return "<body class=\"\" style=\"background-color: #f6f6f6; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;\">\n" +
                ...
                "                        Hi "+name+",</p>\n" +
                "                      <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;\">Your Verification Code for resetting your account password is: </p>\n" +
                "                      <br />\n" +
                ...
                "                      </table>\n" +
                "                      <br>\n" +
                "                      <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;\"> If you didn't request for verification code, don't worry your account is absolutely safe. You can ignore this email. <br></p>\n" +
                "\n" +
                "                      <p>In case you encounter any problem, please contact us at <a href=\"mailto:${supportMail}\" style=\"color: #3498db;font-size: 14px !important;\">support.healthchain@gmail.com</a>.</p>\n" +
                "                      <br>\n" +
                "                      <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;\">\n" +
                "                        Regards, <br>\n" +
                "                        Team Health Chain</p>\n" +
                ...
                "                    <a href=\"${siteLink}\" style=\"color: #999999; font-size: 12px !important; text-decoration: none;\">Health Chain</a> &copy; "+year+"\n" +
                "                  </div>\n" +
                "                </td>\n" +
                "              </tr>\n" +
                "            </table>\n" +
    ...
    public String getRegisterTemplate()
    {
        return "<body class=\"\" style=\"background-color: #f6f6f6; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;\">\n" +
                ...
                "                      <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;\">\n" +
                "                        Hi "+name+",</p>\n" +
                "                      <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;\">Your Verification Code for account verification is: </p>\n" +
                "                      <br />\n" +
                "                      <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"btn btn-primary\" style=\"border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; box-sizing: border-box;\">\n" +
                "                        <tbody>\n" +
                "                          <tr>\n" +
